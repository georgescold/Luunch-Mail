...
### Dossier `./outreach/` (cold email)
- `./outreach/00-fondamentaux-cold-email-outreach.md` — comment marche l'outreach (délivrabilité, warmup, SPF/DKIM/DMARC, rotation de boîtes, infra, KPIs, frontend/backend).
- `./outreach/01-smartlead-fiche-complete.md` — tous les modules Smartlead.
- `./outreach/02-instantly-fiche-complete.md` — tous les modules Instantly.
- `./outreach/03-comparaison-smartlead-vs-instantly.md` — différences et différenciateurs.
- `./outreach/README.md` — index.

### Dossier `./marketing/` (email marketing)
- `./marketing/00-fondamentaux-email-marketing.md` — concepts (opt-in, listes/segments, flows, CDP, transactionnel, omnicanal, KPIs, marketing autonome).
- `./marketing/01-klaviyo-fiche-complete.md` — tous les modules Klaviyo.
- `./marketing/02-activecampaign-fiche-complete.md` — tous les modules ActiveCampaign.
- `./marketing/03-comparaison-klaviyo-vs-activecampaign.md` — différences.
- `./marketing/04-resend-fiche-complete.md` — Resend (API, React Email, Broadcasts, délivrabilité).
- `./marketing/README.md` — index + les deux catégories d'outils.
...
## 13. Pour démarrer
1. **Lis** : toutes les fiches de `./outreach/` et `./marketing/`, puis `./DESIGN.md`.
